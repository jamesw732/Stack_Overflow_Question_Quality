...
## Classification
We used three classification methods: Logistic Regression, Support Vector Classifier, and Extreme Gradient Boosted Trees. We expected logistic regression to perform worse than the other two, however we included it for convenient feature analysis. 
