...
Using score, we can analyze the importance of each feature. We computed the Pearson Correlation Coefficient of each feature with score (not positive or negative score, the raw score). This is summarized in @fig-correlation:

![Pearson Correlation between Features and Score](correlation.png){#fig-correlation width=80% .absolute}
